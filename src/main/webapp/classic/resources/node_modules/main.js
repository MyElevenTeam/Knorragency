...
var _extends =
  ...
  ChuShouGuanLi = createReactClass({
    ...
    getInitialState: function getInitialState() {
      var a = this;
      return (
        axios.get("/user/current").then(function(b) {
          a.setState({ userId: parseInt(b.data.msg, 10) });
        }),
        axios.get("/group/current").then(function(b) {
    ...
    fetch: function fetch() {
      ...
      "" !== this.state.houseNameFilter &&
        ...
        axios
          .get(
            "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
              ? "/houses/search/findByHouseNameLikeAndHousePositionLikeAndHouseTypeAndUserId"
              : "/houses/search/findByHouseNameLikeAndHousePositionLikeAndHouseTypeAndOwn",
            {
              params: _extends(
                {
                  houseType: "\u51FA\u552E",
    ...
    onSelectChange: function onSelectChange(a) {
      this.setState({ selectedRowKeys: a });
    },
    ...
    componentWillUnmount: function componentWillUnmount() {
      document
        .querySelectorAll("div.x-container div.x-panel")
        .forEach(function(a) {
          return (a.style.minHeight = null);
        }),
        document
          .querySelectorAll("div.x-container div.x-autocontainer-outerCt")
          .forEach(function(a) {
            return (a.style.minWidth = null);
          });
    },
    render: function() {
      var c = this,
      ...
      return React.createElement(
        ...
        "{\u7BA1\u7406\u5458}" === this.state.groupName ||
        "{\u603B\u7ECF\u7406}" === this.state.groupName ||
        "{\u603B\u7ECF\u7406\u79D8\u4E66}" === this.state.groupName ||
        "{\u5E02\u573A\u7ECF\u7406}" === this.state.groupName ||
        "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
          ? React.createElement(
              "div",
              null,
      ...
      this.setState({ map: a }),
        a.on("complete", function() {
          axios
            .get(
              "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
                ? "/houses/search/findByUserId"
                : "/houses/search/findByOwn",
              {
                params: {
                  userId:
                    "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
  ...
  QiuGouKeHuGuanLi = createReactClass({
    displayName: "QiuGouKeHuGuanLi",
    getInitialState: function getInitialState() {
      var a = this;
      return (
        axios.get("/user/current").then(function(b) {
    ...
    handleHouseNameFilter: function handleHouseNameFilter(a) {
      this.fetch({ customerName: a });
    },
    handleHousePositionFilter: function handleHousePositionFilter(a) {
      this.fetch({ customerPosition: a });
    },
    handleTableChange: function handleTableChange(a) {
      var d = _extends({}, this.state.pagination);
      (d.current = a.current),
    ...
    fetch: function fetch() {
      ...
      "" !== this.state.customerName &&
        (b = "%" + this.state.customerName + "%"),
        "" !== this.state.customerPosition &&
          (c = "%" + this.state.customerPosition + "%"),
        a.customerName !== void 0 && (b = "%" + a.customerName + "%"),
        a.customerPosition !== void 0 && (c = "%" + a.customerPosition + "%"),
        "" === a.customerName && (b = "%"),
        "" === a.customerPosition && (c = "%"),
        this.setState({ loading: !0 }),
        axios
          .get(
            "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
              ? "/customers/search/findByCustomerNameLikeAndCustomerPositionLikeAndCustomerTypeAndUserId"
              : "/customers/search/findByCustomerNameLikeAndCustomerPositionLikeAndCustomerTypeAndOwn",
            {
              params: _extends(
                {
                  customerType: "\u51FA\u552E",
                ...
                a,
                { customerName: b, customerPosition: c }
              )
            }
          )
          .then(function(f) {
            ...
            (g.total = f.data.page.totalElements),
              d.setState({
                dataSource: f.data._embedded.customers,
                pagination: g,
                selectedRowKeys: [],
                loading: !1
              }),
              a.customerName !== void 0 &&
                d.setState({ customerName: a.customerName }),
              a.customerPosition !== void 0 &&
                d.setState({ customerPosition: a.customerPosition });
          });
    },
    handleAdd: function handleAdd() {
      this.setState({
    ...
    handleUpdate: function handleUpdate(a) {
      ...
      try {
        for (
          var c, d, b = this.state.dataSource[Symbol.iterator]();
          !(_iteratorNormalCompletion6 = (c = b.next()).done);
        ...
        (_didIteratorError6 = !0), (_iteratorError6 = f);
      } finally {
        try {
          !_iteratorNormalCompletion6 && b.return && b.return();
        } finally {
    ...
    handleDeleteAll: function handleDeleteAll() {
      ...
      try {
        for (
          var c, d, b = this.state.selectedRowKeys[Symbol.iterator]();
          !(_iteratorNormalCompletion7 = (c = b.next()).done);
          _iteratorNormalCompletion7 = !0
        )
          (d = c.value),
            a.push(axios.delete(this.state.dataSource[d]._links.self.href));
      } catch (f) {
        (_didIteratorError7 = !0), (_iteratorError7 = f);
      } finally {
        try {
          !_iteratorNormalCompletion7 && b.return && b.return();
        } finally {
    ...
    modalOk: function modalOk() {
      var a = this;
      return "" === this.state.modalValue.customerName
        ? void this.setState({
            modalErrorVisible: !0,
            modalError: "\u5BA2\u6E90\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"
          })
        : "" === this.state.modalValue.customerPosition
          ? void this.setState({
              modalErrorVisible: !0,
              modalError: "\u4F4D\u7F6E\u4E0D\u80FD\u4E3A\u7A7A"
            })
          : "" === this.state.modalValue.customerPrice
            ? void this.setState({
                modalErrorVisible: !0,
                modalError: "\u552E\u4EF7\u4E0D\u80FD\u4E3A\u7A7A"
              })
            : "" === this.state.modalValue.customerProportion
              ? void this.setState({
                  modalErrorVisible: !0,
                  modalError: "\u9762\u79EF\u4E0D\u80FD\u4E3A\u7A7A"
                })
              : Number.isNaN(
                  parseFloat(this.state.modalValue.customerPrice, 10)
                )
                ? void this.setState({
                    modalErrorVisible: !0,
                    modalError: "\u552E\u4EF7\u5FC5\u987B\u4E3A\u6570\u5B57"
                ...
                : Number.isNaN(
                    parseFloat(this.state.modalValue.customerProportion, 10)
                  )
                  ? void this.setState({
                      modalErrorVisible: !0,
                      modalError: "\u9762\u79EF\u5FC5\u987B\u4E3A\u6570\u5B57"
    ...
    tableActions: function tableActions(a, b) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          {
            onClick: function onClick() {
              return theObj.handleDelete(b._links.self.href);
            }
          },
          "\u5220\u9664"
        )
        ...
        "{\u5E02\u573A\u6587\u5458}" === this.state.groupName
          ? React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(antd.Input, {
                  placeholder: "\u5BA2\u6E90\u540D\u79F0",
                  value: this.state.modalValue.customerName,
                  style: { marginBottom: "16px" },
                  onChange: function onChange(d) {
                    return c.setState({
                      modalValue: _extends({}, c.state.modalValue, {
                        customerName: d.target.value
                      })
                    });
                  }
                }),
                React.createElement(antd.Input, {
                  placeholder: "\u552E\u4EF7",
                  value: this.state.modalValue.customerPrice,
                  style: { marginBottom: "16px" },
                  onChange: function onChange(d) {
                    return c.setState({
                      modalValue: _extends({}, c.state.modalValue, {
                        customerPrice: d.target.value
                      })
                    });
                  }
                }),
                React.createElement(antd.Input, {
                  placeholder: "\u9762\u79EF",
                  value: this.state.modalValue.customerProportion,
                  style: { marginBottom: "16px" },
                  onChange: function onChange(d) {
                    return c.setState({
                      modalValue: _extends({}, c.state.modalValue, {
                        customerProportion: d.target.value
                      })
                    });
                  }
                }),
                React.createElement(antd.Input, {
                  placeholder: "\u4F4D\u7F6E",
                  value: this.state.modalValue.customerPosition,
                  style: { marginBottom: "16px" },
                  onChange: function onChange(d) {
                    return c.setState({
                      modalValue: _extends({}, c.state.modalValue, {
                        customerPosition: d.target.value
                      })
                    });
                  }
                }),
  ...
  QiuZuKeHuGuanLi = createReactClass({
    displayName: "QiuZuKeHuGuanLi",
    getInitialState: function getInitialState() {
      var a = this;
      return (
        axios.get("/user/current").then(function(b) {
    ...
    handleUpdate: function handleUpdate(a) {
      ...
      try {
        for (
          var c, d, b = this.state.dataSource[Symbol.iterator]();
          !(_iteratorNormalCompletion8 = (c = b.next()).done);
        ...
        (_didIteratorError8 = !0), (_iteratorError8 = f);
      } finally {
        try {
          !_iteratorNormalCompletion8 && b.return && b.return();
        } finally {
    ...
    handleDeleteAll: function handleDeleteAll() {
      var a = [],
        _iteratorNormalCompletion9 = !0,
        _didIteratorError9 = !1,
        _iteratorError9 = void 0;
      try {
        for (
          var c, d, b = this.state.selectedRowKeys[Symbol.iterator]();
          !(_iteratorNormalCompletion9 = (c = b.next()).done);
          _iteratorNormalCompletion9 = !0
        )
          (d = c.value),
            a.push(axios.delete(this.state.dataSource[d]._links.self.href));
      } catch (f) {
        (_didIteratorError9 = !0), (_iteratorError9 = f);
      } finally {
        try {
          !_iteratorNormalCompletion9 && b.return && b.return();
        } finally {
  ...
  WoDeKeYuanGuanLi = createReactClass({
    displayName: "WoDeKeYuanGuanLi",
    getInitialState: function getInitialState() {
      var a = this;
      return (
        axios.get("/user/current").then(function(b) {
    ...
    fetch: function fetch() {
      ...
      "" !== this.state.customerName &&
        ...
        axios
          .get(
            "/customers/search/findByCustomerNameLikeAndCustomerPositionLikeAndUserId",
            {
              params: _extends({ userId: this.state.userId, size: 10 }, a, {
                customerName: b,
                customerPosition: c
              })
            }
    ...
    handleUpdate: function handleUpdate(a) {
      ...
      try {
        for (
          var c, d, b = this.state.dataSource[Symbol.iterator]();
          !(_iteratorNormalCompletion10 = (c = b.next()).done);
        ...
        (_didIteratorError10 = !0), (_iteratorError10 = f);
      } finally {
        try {
          !_iteratorNormalCompletion10 && b.return && b.return();
        } finally {
    ...
    handleDeleteAll: function handleDeleteAll() {
      var a = [],
        _iteratorNormalCompletion11 = !0,
        _didIteratorError11 = !1,
        _iteratorError11 = void 0;
      try {
        for (
          var c, d, b = this.state.selectedRowKeys[Symbol.iterator]();
          !(_iteratorNormalCompletion11 = (c = b.next()).done);
          _iteratorNormalCompletion11 = !0
        )
          (d = c.value),
            a.push(axios.delete(this.state.dataSource[d]._links.self.href));
      } catch (f) {
        (_didIteratorError11 = !0), (_iteratorError11 = f);
      } finally {
        try {
          !_iteratorNormalCompletion11 && b.return && b.return();
        } finally {
